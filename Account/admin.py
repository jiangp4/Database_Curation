...
class CuratorAdmin(UserAdmin):
    ...
    ordering = ('username',)
    list_display = ['id', 'username', 'first_name', 'last_name', 'email', 'birth_date', 'institute', 'education', 'url', 'bio', 'allowance', 'keywords_highlight', 'show_curated']
    search_fields = ('username', 'first_name', 'last_name', 'email', 'birth_date', 'institute', 'education', 'bio', 'allowance', 'keywords_highlight', 'show_curated')
    ...
    def change_view(self, request, object_id):
        ...
        if request.user.is_superuser:
            self.fieldsets = (
                ...
                ('Personal info', {'fields': ('first_name', 'last_name', 'email', 'birth_date', 'education', 'url', 'bio', 'keywords_highlight', 'show_curated')}),
